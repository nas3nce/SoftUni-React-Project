        ...
        <>
            ...
            <div className="catalogContainer">
                <div className="card">
                    ...
                    <Link to={`id`}><Button variant="dark">Read More</Button> </Link>
                </div>
                <div className="card">
                    <img src="public\images\123.jpg" alt="" />
                    <h3 >ala bala</h3>
                    <p > Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum</p>
                    <Link to={`id`}><Button variant="dark">Read More</Button> </Link>                </div>
                <div className="card">
                    <img src="public\images\background.jpg" alt="" />
                    <h3 >ala bala</h3>
                    <p > Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum</p>
                ...
                <div className="card">
                    ...
                    <h3 >ala bala</h3>
                    <p > Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum</p>
                    <Link to={`id`}><Button variant="dark">Read More</Button> </Link>                </div>                <div className="card">
                    <img src="public\images\1231.jpg" alt="" />
                    <h3 >ala bala</h3>
                    <p > Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum Lorem, Lorem ipsum</p>
                    <Link to={`id`}><Button variant="dark">Read More</Button> </Link>                </div>
